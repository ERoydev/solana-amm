...
export function CounterCreate() {
  const { initialize } = useCounterProgram() // Custom hook
  // This shows how the initialize function can be used to create a new counter account
  // It returns a button that, when clicked, will create a new counter account on the blockchain
  // The button is disabled while the transaction is pending
